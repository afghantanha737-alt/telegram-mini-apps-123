  ...
  content.innerHTML = `
    ...
    <div class="card">
      <p style="font-size:11px;margin-bottom:0">
        ${t("wallet_rate_label", { rate: formatNumber(state.rate, 6) })}
        •
        ${t("wallet_min_withdraw_note", { n: formatNumber(state.minWithdrawGram, 6) })}
      </p>
    </div>
...
function renderProfileReferral() {
  return `
    ...
    <div class="card">
      ...
      <button class="primaryBtn" type="button" onclick="shareReferralLink()">
