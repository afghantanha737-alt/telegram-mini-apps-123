...
const TRANSLATIONS = {
  fa: {
    ...
    wallet_min_withdraw_note: "حداقل مقدار برای ثبت درخواست برداشت: {n} پوینت.",
  ...
  ps: {
    ...
    wallet_min_withdraw_note: "لږترلږه اندازه د باسلو غوښتنې لپاره: {n} پوائن.",
  ...
  en: {
    ...
    wallet_min_withdraw_note: "Minimum amount to request a withdrawal: {n} points.",
