...
const TRANSLATIONS = {
  fa: {
    ...
    daily_ads_title: "پاداش تبلیغاتی روزانه",
    daily_ads_desc: "با تماشای یک تبلیغ کوتاه، {points} پوینت اضافه دریافت کن.",
    daily_ads_button: "تماشای تبلیغ",
    daily_ads_limit_button: "سقف امروز پر شد",
    daily_ads_limit_toast: "سقف تماشای تبلیغ امروز پر شده است.",
    daily_ads_reward_toast: "{n}+ پوینت گرفتی!",
    daily_ads_remaining: "{watched} از {limit} تبلیغ امروز دیده شده",
  ...
  ps: {
    ...
    daily_ads_title: "د ورځني اعلان بدله",
    daily_ads_desc: "د یو لنډ اعلان په کتلو سره {points} اضافي پوائنټونه ترلاسه کړئ.",
    daily_ads_button: "اعلان کتل",
    daily_ads_limit_button: "د نن حد ډک شو",
    daily_ads_limit_toast: "د نن ورځې د اعلان کتلو حد ډک شوی.",
    daily_ads_reward_toast: "{n}+ پوائنټ ترلاسه شو!",
    daily_ads_remaining: "{watched} د {limit} نه، نن لیدل شوي",
  ...
  en: {
    ...
    daily_ads_title: "Daily reward ad",
    daily_ads_desc: "Watch a short ad to earn {points} bonus points.",
    daily_ads_button: "Watch ad",
    daily_ads_limit_button: "Today's limit reached",
    daily_ads_limit_toast: "You've reached today's ad watch limit.",
    daily_ads_reward_toast: "{n}+ points earned!",
    daily_ads_remaining: "{watched} of {limit} ads watched today",
...
const ERROR_CODE_MAP = {
  ...
  AD_LIMIT_REACHED: { fa: "سقف تماشای تبلیغ امروز پر شده است.", ps: "د نن ورځې د اعلان کتلو حد ډک شوی.", en: "You've reached today's ad watch limit." }
};
