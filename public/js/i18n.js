...
const TRANSLATIONS = {
  fa: {
    ...
    ads_waiting: "ثبت تبلیغ کمی زمان می‌برد؛ بعداً دوباره بررسی کن.",
    ads_done: "تکمیل شد",
  ...
  ps: {
    ...
    ads_waiting: "د اعلان ثبتول لږ وخت نیسي؛ وروسته بیا وګورئ.",
    ads_done: "بشپړ شو",
  ...
  en: {
    ...
    ads_waiting: "Ad registration may take a moment; check again shortly.",
    ads_done: "Completed",
