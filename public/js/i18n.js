...
const TRANSLATIONS = {
  fa: {
    ...
    exchange_choose_title: "نوع تبدیل را انتخاب کن",
    exchange_points_to_gram: "تبدیل Point به GRAM",
    exchange_gram_to_points: "تبدیل GRAM به Point",
    gram_to_points_modal_title: "تبدیل GRAM به پوینت",
    gram_to_points_label: "مقدار GRAM",
    gram_to_points_result_label: "معادل Point دریافتی",
    gram_to_points_submit: "تبدیل کن",
    ...
    menu_history: "History / Transactions",
    history_title: "History / Transactions",
    history_empty: "هنوز تراکنشی ثبت نشده است.",
    history_loading: "در حال بارگذاری تاریخچه...",
    history_transaction_id: "شناسه تراکنش",
    history_user_id: "شناسه کاربر",
    history_date: "تاریخ و ساعت",
    history_increase: "افزایش",
    history_decrease: "کاهش",
    history_neutral: "ثبت رویداد",
    history_point_unit: "Point",
    history_gram_unit: "Gram",
    transaction_type_ad_view: "ثبت مشاهده تبلیغ",
    transaction_type_ad_reward: "پاداش تبلیغ",
    transaction_type_task_reward: "پاداش تسک",
    transaction_type_daily_checkin: "پاداش ورود روزانه",
    transaction_type_spin_reward: "پاداش گردونه",
    transaction_type_exchange: "تبدیل موجودی",
    transaction_type_referral_bonus: "پاداش Referral",
    transaction_type_withdrawal_audit: "برداشت Gram",
    transaction_type_opening_balance: "موجودی اولیه",
  ...
  ps: {
    ...
    exchange_choose_title: "د بدلولو ډول غوره کړئ",
    exchange_points_to_gram: "Point په GRAM بدلول",
    exchange_gram_to_points: "GRAM په Point بدلول",
    gram_to_points_modal_title: "GRAM په Point بدلول",
    gram_to_points_label: "د GRAM اندازه",
    gram_to_points_result_label: "ترلاسه کېدونکي Point",
    gram_to_points_submit: "بدلول",
    ...
    menu_history: "History / Transactions",
    history_title: "History / Transactions",
    history_empty: "تر اوسه هېڅ تراکنش نشته.",
    history_loading: "تاریخچه پورته کېږي...",
    history_transaction_id: "د تراکنش پېژندنه",
    history_user_id: "د کارن پېژندنه",
    history_date: "نېټه او وخت",
    history_increase: "زیاتوالی",
    history_decrease: "کموالی",
    history_neutral: "رویداد ثبت شو",
    history_point_unit: "Point",
    history_gram_unit: "Gram",
    transaction_type_ad_view: "د اعلان لیدل",
    transaction_type_ad_reward: "د اعلان انعام",
    transaction_type_task_reward: "د دندې انعام",
    transaction_type_daily_checkin: "د ورځني ننوتلو انعام",
    transaction_type_spin_reward: "د ګرځنده انعام",
    transaction_type_exchange: "د بیلانس بدلول",
    transaction_type_referral_bonus: "د Referral انعام",
    transaction_type_withdrawal_audit: "د Gram ایستل",
    transaction_type_opening_balance: "لومړنی بیلانس",
  ...
  en: {
    ...
    exchange_choose_title: "Choose conversion type",
    exchange_points_to_gram: "Convert Point to GRAM",
    exchange_gram_to_points: "Convert GRAM to Point",
    gram_to_points_modal_title: "Convert GRAM to points",
    gram_to_points_label: "GRAM amount",
    gram_to_points_result_label: "Points received",
    gram_to_points_submit: "Convert",
    ...
    history_loading: "Loading transaction history...",
    history_transaction_id: "Transaction ID",
    history_user_id: "User ID",
    history_date: "Date and time",
    history_increase: "Increase",
    history_decrease: "Decrease",
    history_neutral: "Event recorded",
    history_point_unit: "Point",
    history_gram_unit: "Gram",
    transaction_type_ad_view: "Ad view recorded",
    transaction_type_ad_reward: "Ad reward",
    transaction_type_task_reward: "Task reward",
    transaction_type_daily_checkin: "Daily check-in reward",
    transaction_type_spin_reward: "Spin wheel reward",
    transaction_type_exchange: "Balance conversion",
    transaction_type_referral_bonus: "Referral reward",
    transaction_type_withdrawal_audit: "Gram withdrawal",
    transaction_type_opening_balance: "Opening balance",
...
const ERROR_CODE_MAP = {
  ...
  LEDGER_DUPLICATE: { fa: "این تبدیل قبلاً ثبت شده یا با سابقه قبلی تداخل دارد.", ps: "دا بدلون مخکې ثبت شوی یا له پخوانۍ سابقې سره ټکر لري.", en: "This conversion was already recorded or conflicts with an older ledger entry." },
  LEDGER_VALIDATION: { fa: "ثبت سابقه تبدیل با داده‌های فعلی انجام نشد.", ps: "د بدلون سابقه د اوسنیو معلوماتو له مخې ثبت نه شوه.", en: "The conversion history could not be recorded." },
  TRANSACTION_UNAVAILABLE: { fa: "ارتباط امن با دیتابیس برای تبدیل آماده نیست.", ps: "د بدلون لپاره له ډیټابیس سره خوندي اړیکه چمتو نه ده.", en: "The secure database connection for conversion is unavailable." },
